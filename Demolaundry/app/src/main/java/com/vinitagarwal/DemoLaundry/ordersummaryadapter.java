...
public class ordersummaryadapter extends RecyclerView.Adapter {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        try {
            viewholder.productname.setText(list.get(position).getString("productname").trim());
            viewholder.productprice.setText(list.get(position).getString("productprice").trim());
            viewholder.producttotal.setText(list.get(position).getString("producttotal").trim());
